...
% Data(1,1) = 
Titles = {'Lacunar ID', 'Ellipsoidal Surface Area', 'Ellipsodial Sphericity','Ellipsoidal Oblateness' ...
             'Ellipsodial Volume','Lacunar Surface Area','Lacunar Sphericity', ...
...
Data = [LacArr, eliSurfArea, eliSphericity, eliVol,eliOblateness, lacSurfArea, ...
       lacSphericity, LacVol, ThetaVec, PhiVec, spanTheta, shrtCOMDist, ...
